---
layout: default
title: Supporting Information for "Construction, Deployment, and Usage of the Human Reference Atlas Knowledge Graph"
---

# Supporting Information for “Construction, Deployment, and Usage of the Human Reference Atlas Knowledge Graph”
...
| Digital objects counts in the latest HRA release    	| type,count<br>2d-ftu,23<br>asct-b,38<br>ctann,3<br>omap,23<br>ref-organ,74 (includes two United files with all organs plus a crosswalk to ASCT+B tables)<br>vascular-geometry,1                                                                     	| [Query](https://apps.humanatlas.io/api/grlc/hra.html#get-/digital-object-count) 	|
...
| ASCT+B TEMP IDs in HRA                              	| asctb_type,count<br>AS,951<br>CT,221<br>BM (gene),220<br>BM (protein),62<br>BM (lipids),9<br>BM (metabolites),5<br>BM (proteoforms),4                                 	| [Query](https://apps.humanatlas.io/api/grlc/hra.html#get-/kg-asctb-temp) 	|
| HRApop                                              	|                                                                                                                                                                       	|       	|
